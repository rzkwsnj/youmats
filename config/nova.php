...
return [
    ...
    */
    ...
    | Nova License key
    |--------------------------------------------------------------------------
    | This option allow you to add your licence key. (Best to be used as env variable).
    |
    */
    ...
    | Nova Brand
    |--------------------------------------------------------------------------
    | This option allow you to customize the logo displayed.
    | Please make sure to use SVG and enable dark mode for best results.
    |
    */

    'brand' => [
        'logo' => public_path('assets/img/logo.svg') // What ever your logo path in your project
    ],
