        ...
        <div class="section-main">
            ...
            <div class="section-login-2 login-sides">
                <div class="section-login-2-main">
                    ...
                    <h1 class="section-login-2-title">{{ __('auth.vendor_login') }}</h1>
                    <form class="section-login-2-form" method="POST" action="{{ route('vendor.login') }}">
                        @csrf
                        ...
                        <div class="login-form-5">
                             <p><a href="{{ route('vendor.password.request') }}">{{ __('auth.forget_password') }}</a></p>
                        </div>
                        @endif
                        <div class="login-form-5">
                            <p>{{ __('auth.not_member') }} <a href="{{route('vendor.register')}}">{{ __('auth.register') }}</a></p>
                        </div>
                    </form>
