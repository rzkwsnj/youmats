...
<h3 class="flex items-center mb-6 text-base font-normal text-white no-underline">
...
<ul class="mb-8 list-reset">
    ...
    <li class="mb-4 ml-8 text-sm leading-tight">
        <router-link :to="{
                    ...
                    }" class="text-justify text-white no-underline dim" dusk="{{ $resource::uriKey() }}-resource-link">
            {{ $resource::label() }}
        </router-link>
    </li>
    @endforeach
