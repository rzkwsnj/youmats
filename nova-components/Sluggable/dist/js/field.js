  ...
  methods: {
    ...
    changeListener: function changeListener(value) {
      ...
      return function (value) {
        _this.value = slugify(value, _this.field.separator);
      };
    },
    registerChangeListener: function registerChangeListener() {
      var _this2 = this;
      Nova.$on(this.eventName, function (value) {
        _this2.value = _this2.slugify(value, _this2.field.separator);
        console.log(_this2);
      });
    },
    toggleCustomizeClick: function toggleCustomizeClick() {
    ...
    slugify: function slugify(value) {
      ...
      return slugify__WEBPACK_IMPORTED_MODULE_2___default()(lodash_lowerCase__WEBPACK_IMPORTED_MODULE_1___default()(value), separator);
    }
  },
  computed: {
    ...
    eventName: function eventName() {
      var from = this.field.from.replace('*', this.translatableLocale);
      return "".concat(from, "-change");
    },
...
Nova.booting(function (app, store) {
  app.component('index-Sluggable', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-Sluggable', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-Sluggable', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkzakariatlilani_sluggable"] = self["webpackChunkzakariatlilani_sluggable"] || [];
